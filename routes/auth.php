...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:admin,superadmin')->group(function () {
        Route::get('users', [RegisteredUserController::class, 'show'])
            ->name('users.list');
        ...
        Route::get('users/{user}/change-password', [RegisteredUserController::class, 'showChangePasswordForm'])
            ->name('users.change-password.form');

        Route::patch('users/{user}/change-password', [RegisteredUserController::class, 'changePassword'])
